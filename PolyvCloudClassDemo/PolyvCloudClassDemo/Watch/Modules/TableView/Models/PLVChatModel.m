...
@implementation PLVChatTextContent

- (instancetype)initWithText:(NSString *)text {
    if (self = [super init]) {
        self.text = text;
        self.attributedText = [[PLVEmojiManager sharedManager] convertTextEmotionToAttachment:text font:plv_chat_text_font()];
    }
    return self;
}
...
- (instancetype)initWithText:(NSString *)text audience:(BOOL)audience {
    ...
    if (self) {
        ...
        self.textColor = audience ? normalColor : specialColor;
    }
    return self;
}
...
- (PLVBaseCell *)makeCellWithTableView:(UITableView *)tableView {
    ...
    switch (self.type) {
        ...
        case PLVChatModelTypeOtherSpeak: {
            ...
            cell.myMessage = self.type==PLVChatModelTypeMySpeak;
        } break;
        case PLVChatModelTypeMyImage:
        case PLVChatModelTypeOtherImage: {
            ...
            cell.myMessage = self.type==PLVChatModelTypeMyImage;
        } break;
        default: {
        } break;
    }
