...
- (void)loadSubViews:(BOOL)audio teacher:(BOOL)teacher me:(BOOL)me showTrophy:(BOOL)trophy {
    ...
    self.imgView = [[UIImageView alloc] initWithImage:[PCCUtils getLinkMicImage:@"plv_linkMic_camera_background"]];
    ...
    self.micPhoneImgView = [[UIImageView alloc] initWithImage:[PCCUtils getLinkMicImage:@"plv_linkMic_micphoneOff"]];
    self.micPhoneImgView.hidden = YES;
    [self.mainView addSubview:self.micPhoneImgView];
    
    self.permissionImgView = [[UIImageView alloc] initWithImage:[PCCUtils getLinkMicImage:@"plv_linkMic_permission"]];
    ...
    UIImageView *trophyImageView = [[UIImageView alloc] initWithImage:[PCCUtils getLinkMicImage:@"plv_icon_trophy"]];
